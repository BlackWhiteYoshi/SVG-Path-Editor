...
export class Point {
    ...
    public constructor(p: Coordinate, editor: SvgPathEditor) {
        this.p = p;
        this.editor = editor;
    }

    public get x(): Decimal { return this.p.x; }

    public get y(): Decimal { return this.p.y; }
    ...
    private pDiv: HTMLDivElement | null = null;
     ...
     * </div>
     */
    public createInputPair(argumentDiv: HTMLDivElement) {
    ...
    private dragCoordinateX = 0;
    private dragCoordinateY = 0;
    private dragPoint: Coordinate = { x: new Decimal(0), y: new Decimal(0) };

    private dotPointerDown = (event: PointerEvent) => {
    ...
    private dotPointerMove = (event: PointerEvent) => {
    ...
    private dotPointerUp = (event: PointerEvent) => {
        this.pDot!.style.cursor = "grab";
